...
export function CreateSalesInvoiceModal({
  ...
  const [lines, setLines] = useState<LineDraft[]>([
    { description: "", revenueAccountCode: "", amount: "", vatRate: "15" },
  ]);
  ...
  function addLine() {
    setLines((prev) => [...prev, { description: "", revenueAccountCode: "", amount: "", vatRate: "15" }]);
  }
  ...
  return (
    <Modal title="New sales invoice" onClose={onClose} widthClassName="max-w-2xl">
                ...
                <div className="col-span-3">
                  <Field label="Revenue account">
                    <Select
                      ...
                      onChange={(e) => updateLine(i, { revenueAccountCode: e.target.value })}
                    >
